...
1. In the **Composer**, select the accounts you want to post to from the list on the left
2. You can filter accounts by platform (Facebook, X, LinkedIn, etc.)

![Select accounts to post to](./img/post-to-accounts.jpg)
...
![AI Content Generation](./img/ai-content-generation.jpg)
