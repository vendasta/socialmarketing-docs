...
- Always accept all requested permissions during connection
- Ensure you have an **Admin role** on the Page
- If permissions change or a password is updated, reconnect immediately
...
5. Check platform status for outages  
6. Contact Social Marketing support  
