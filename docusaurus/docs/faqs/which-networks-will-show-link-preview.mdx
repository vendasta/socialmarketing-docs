...
When creating a social post in Social Marketing, a link to an interesting article, a page on their website, or other interesting web content can be attached to a post on any network using the link-shortening tool ![Link shortening tool](./img/shorten-link.png) or by copying and pasting the link directly into the Content section.
...
![Link preview example](./img/link-preview-coffee.png)
