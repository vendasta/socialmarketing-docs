---
title: Using Images and Videos in Social Marketing
description: A complete guide to uploading, generating, and optimizing images and videos in Social Marketing
sidebar_position: 1
---

# Using Images and Videos in Social Marketing
...
Post video content to multiple social networks from a single dashboard.

**How to Post a Video:**
1. Click **Compose**
2. Add your caption
3. Click **Add Media** and upload a `.mp4` or `.mov` file
4. Select networks
5. Post now, schedule, or save as draft

> **Note:** Google Business Profile does **not** support video posting.

---

## Image & Video Specs by Platform
...
**Max file size:** 4MB  
**Tips:** Facebook supports up to 10 images per post.
...
**Max file size:** 30MB  
**Tips:** Up to 10 images/videos via carousel.

###Google Business Profile

**Recommended:** 720 x 720 px.    
**Max file size:** 5MB  
**Tips:** 1 image per post, minimal editing recommended.

###X

**Recommended:** 1200 x 675 px  
**Max file size:** 5MB (image), 15MB (GIF)

**Tips:** Up to 4 images per post. GIFs must loop and meet size/frame limits.

###LinkedIn

**Recommended:** 1200 x 627 px  
**Max file size:** 10MB  
**Tips:** Up to 9 images per post.
...
- Max Size: **500MB**  
- Max Length: **60 sec** (Reels: 3 sec – 15 mins)  
- Aspect ratio: 9:16
- Note: Videos post as Reels by default.
...
### Can I add GIFs to social media posts?
...
### Can I post multiple images to Instagram?

Yes. Use the **carousel** feature to upload up to **10 images or videos** in a single Instagram post.

---

### Why doesn’t my video preview in Social Marketing?

Some video formats don’t preview due to encoding issues. Re-export the video using one of the following tools:
...
### Why does Facebook reduce image quality?
...
### Can I post photos to multiple platforms at once?
...
### Can I customize my video thumbnails?

No. Thumbnails are **automatically generated** from the **first frame** of your video.

> **Tip:** To control the thumbnail, edit your video in an external editor like **CapCut**, setting your desired first frame.
...
- **MP4**  
- **MOV**  
- **TikTok** also supports **.webm**

---

### What’s the best image ratio for all platforms?

**Square (1:1)** images offer the most compatibility and consistency across all social networks.

---

### Should I edit AI-generated images?
