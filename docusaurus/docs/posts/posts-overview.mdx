...
Check the [Image and Video Requirements](#) to ensure your media files meet format, size, and resolution standards.
...
Yes. In the Composer, expand **Google Business Profile Options**, choose a CTA (like “Learn More”), and add the destination URL.
