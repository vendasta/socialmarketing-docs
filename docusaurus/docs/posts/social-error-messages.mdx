...
| **Facebook** | `Not intuitive message ( :{"error":{"code":1,"message":"An unknown error occurred","error_subcode":99}})` | Something went wrong when posting to Facebook. Try reposting, and if that fails, recreate the post.  |
